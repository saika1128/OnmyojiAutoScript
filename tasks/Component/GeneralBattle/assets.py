...
# 结算"点击屏幕继续"右侧云朵形可点区（1280x720，贴合实测蓝圈内缘）；方案B：三个 C_REWARD 收进同一云朵、错位子云
_REWARD_CLOUD_SHAPE = [(555, 309), (590, 296), (614, 291), (643, 296), (673, 312), (696, 338), (690, 363), (675, 385), (660, 398), (628, 399), (604, 392), (577, 387), (552, 378), (532, 348), (539, 324)]
...
class GeneralBattleAssets: 
	...
	# description 
	# 原底部横条 (606,603,325,87)；现偏左子云
	C_REWARD_1 = RuleClick(roi_front=(532,291,164,108), roi_back=(516,275,196,140), name="reward_1",
	                     shape=_REWARD_CLOUD_SHAPE, lobes=[((577, 347), 0.65), ((632, 352), 0.35)])
	# description 
	# 原最左竖条 (25,134,224,472)；现偏右下子云
	C_REWARD_2 = RuleClick(roi_front=(532,291,164,108), roi_back=(516,275,196,140), name="reward_2",
	                     shape=_REWARD_CLOUD_SHAPE, lobes=[((653, 352), 0.65), ((600, 364), 0.35)])
	# description 
	# 原最右竖条 (1092,156,168,437)；现偏上中子云
	C_REWARD_3 = RuleClick(roi_front=(532,291,164,108), roi_back=(516,275,196,140), name="reward_3",
	                     shape=_REWARD_CLOUD_SHAPE, lobes=[((614, 332), 0.60), ((576, 362), 0.20), ((652, 368), 0.20)])
