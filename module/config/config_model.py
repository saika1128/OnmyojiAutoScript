...
# [极简绘卷版] 仅保留 Exploration(探索) / RealmRaid(个人突破) / MemoryScrolls(绘卷)
#   其余任务的 import 与字段一律注释隐藏（不删除代码，需要时取消注释即可恢复）。
...
class ConfigModel(ConfigBase):
    ...
    # ===== 以下任务字段在极简版中隐藏（取消注释并恢复上方对应 import 即可还原）=====
    # # 这些是每日任务的
...
if __name__ == "__main__":
    ...
    print(c.script_task('Exploration'))
